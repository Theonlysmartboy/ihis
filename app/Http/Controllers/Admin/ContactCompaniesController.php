...
class ContactCompaniesController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $contacts = \App\Contact::where('company_id', $id)->get();$patients = \App\Patient::where('zone_id', $id)->get();

        $contact_company = ContactCompany::findOrFail($id);

        return view('admin.contact_companies.show', compact('contact_company', 'contacts', 'patients'));
    }
